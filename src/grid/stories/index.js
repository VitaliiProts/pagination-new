...
storiesOf('Lib/Grid', 'GridTable').add('Table', () => ({
    template: `
                <section class="yaware-panel__block">
                    <y-toolbar :expanded.sync="expanded">
                        <template slot="expand-toolbar-button"></template>
                        <template slot="expanded-toolbar">
                            <h1>This is toolbar expanded</h1>
                        </template>
                    </y-toolbar>
                    <y-grid :columns="columns.projects" 
                        ...
                        <template slot="expand">
                            <y-grid :columns="columns.tasks" :data="data.tasks">
